...
def write_allinfo(url,date):
    ...
    with Browser('chrome') as browser:
        ...
        for key, item in enumerate(items):
            try:
                ...
                for consensus_type in consensus_types:
                    ...
                    print("---- 4 - 11 ----")
                    nameThead = nameTable.find('thead')
                    print("---- 4 - 12 ----")
                    nameTr = nameThead.find('tr')
                    print("---- 4 - 13 ----")
                    nameTd = nameTr.find_all('td', attrs={'class': "header-grid"})
                    print("---- 4 - 14 ----")
        ...
        #         'spread_percentage_sbr', 'spread_percentage_sportsplays'] 
                            ...
                            # add home row
                            row_home = ['', '', '', date,
                                    startTime, teamName_home, teamName_away, scoreHome,
                                    scoreAway]
                            print("--- 22 ----")        
                            ...
                            # add away row
                            row_away = ['', '', '', date,
                                    startTime, teamName_away, teamName_home, scoreAway,
                                    scoreHome]
                            print("--- 32 ----")        
